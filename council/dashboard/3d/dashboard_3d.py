...
<div class="ui-overlay">
  <div class="ui-card max-w-md">
    ...
    <div class="mt-4">
      ...
      <p class="text-xs opacity-50 mt-1">Agents: 🧙 Hermes Sage (Memory), 🦞 OpenClaw Executor (Action), 🔧 Agent Zero Builder (Code)</p>
    </div>
  </div>
</div>
...
for (let i = 0; i < 200; i++) {
  ...
  else color = 0x8b5cf6; // Agent Zero - purple - builder
...
// 3 Agents as 3D avatars - Hermes wizard, OpenClaw lobster, Agent Zero builder - larger spheres with different colors and emissive
const agents = [
  ...
  { name: "Agent Zero Builder", color: 0x8b5cf6, pos: new THREE.Vector3(15, 10, 0), emoji: "🔧" }
];
